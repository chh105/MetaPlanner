function [ct, cst, pln, stf] = import_dicom_gym( ctDir, rtStDir, dicomMetaBool, useDoseGrid )
...
resolution.x = 3.5;
resolution.y = 3.5;
resolution.z = 3.5; % [mm] / lps coordinate system
...
%     pln.propStf.gantryAngles    = [0,45,90,135,180,225,270,315]; % [?]
    ...
    pln.propDoseCalc.doseGrid.resolution.x = 3.5; % [mm]
    pln.propDoseCalc.doseGrid.resolution.y = 3.5; % [mm]
    pln.propDoseCalc.doseGrid.resolution.z = 3.5; % [mm]
