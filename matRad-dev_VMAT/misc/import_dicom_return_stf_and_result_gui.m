function [ct, cst, pln, stf, resultGUI] = import_dicom_return_stf_and_result_gui( ctDir, rtStDir, rtDoseDir, mm_resolution, bixel_width, numOfFractions, dicomMetaBool, useDoseGrid )
