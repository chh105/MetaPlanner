function [intersectVolVec] = structureIntersection( ct, volVecA, volVecB )
% 
% call
%   [intersectVolVec] = structureIntersection( ct, volVecA, volVecB );
%
% input
%   ct:             matRad ct object
...
intersectVolVec = find(dummy_vol_A_plus_B>1);
